...
OUTPUT_DIR=$BASE_DIR/results_magnet_v4
...
lm_eval --model vllm \
    --model_args pretrained=${MODEL},dtype=bfloat16,gpu_memory_utilization=0.8,max_model_len=2048,tensor_parallel_size=$NUM_GPUS \
    --tasks ${tasks} \
